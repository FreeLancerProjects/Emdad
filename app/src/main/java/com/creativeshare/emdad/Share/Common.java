...
public class Common {
    ...
    public static ProgressDialog createProgressDialog(Context context , String msg)
    {
        ...
        drawable.setColorFilter(ContextCompat.getColor(context, R.color.yellow1), PorterDuff.Mode.SRC_IN);
    ...
    public static void CreateErrorAlertDialog(Context context, String msg)
    {
