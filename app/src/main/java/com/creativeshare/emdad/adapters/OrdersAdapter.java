...
import com.creativeshare.emdad.activities_fragments.activities.home_activity.fragments.fragment_orders.Fragment_Current_Order;
...
public class OrdersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private Fragment_Current_Order fragment;
    private String user_type;

    public OrdersAdapter(List<OrderDataModel.OrderModel> orderModelList, Context context, Fragment_Current_Order fragment,String user_type) {
        ...
        if (holder instanceof MyHolder) {
            ...
            myHolder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    OrderDataModel.OrderModel orderModel = orderModelList.get(myHolder.getAdapterPosition());
                    fragment.setItemData(orderModel,holder.getAdapterPosition());
                }
            });
